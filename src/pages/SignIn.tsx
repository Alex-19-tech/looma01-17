    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-semibold text-foreground">Prelix</span>
        </div>
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-1 bg-accent px-3 py-1 rounded-full">
            ...
            <span className="text-foreground font-medium">Prelix</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-4">
            ...
            <Button 
              variant="outline" 
              className="w-full h-12 bg-white text-black hover:bg-gray-100 border-gray-300"
            >
