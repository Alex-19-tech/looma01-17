...
const SignUp = () => {
  ...
  const handleGoogleSignUp = () => {
    // Call Supabase Google OAuth directly
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-6">
          <div className="flex items-center justify-center gap-3">
            ...
            <span className="text-3xl font-bold text-foreground">Prelix</span>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            >
              <div onSubmit={handleEmailSignUp} className="space-y-4 pt-2">
        ...
        {/* Terms */}
        <div className="text-center text-sm text-muted-foreground leading-relaxed px-4">
